...
(function (global, factory) {
  ...
  function conflictDetection() {
    ...
    var teprojectount = Object.keys(scriptsToTest).length + Object.keys(cssToTest).length; // The resultsCollectionMaxWait allows for the time between when the tests running under
    ...
    if (teprojectount === 0) {
      ...
      console.info("Testing ".concat(teprojectount, " possible conflicts."));
      ...
      pollUntil({
        ...
        fn: function fn() {
          return Object.keys(nodesTested.conflict).length + Object.keys(nodesTested.noConflict).length >= teprojectount;
        }
      }).then(function () {
        console.info('DONE!');
        setDoneResults({
